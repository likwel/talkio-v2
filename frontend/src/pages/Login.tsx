    ...
    <div className="grid min-h-dvh place-items-center overflow-y-auto p-4 py-10">
      <form onSubmit={submit} className="w-full max-w-sm space-y-4 rounded-3xl border border-[var(--outline)] bg-[var(--surface)] p-8 shadow-elevation-1">
        <div className="flex items-center gap-2">
          <span className="grid h-10 w-10 place-items-center rounded-xl bg-brand-600 text-lg font-bold text-white">T</span>
          <div>
            <h1 className="text-xl font-medium">Talkio</h1>
            <p className="text-xs text-slate-500">Messagerie, visio, agenda, kanban, MEAL</p>
          </div>
        </div>
